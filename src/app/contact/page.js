    ...
    <main className="w-100vw h-[100vh] overflow-x-hidden overflow-y-scroll relative">
      ...
      <div className="main__flex__contact">
        <div className="title__div">
          <h1 className="main__contact__title">GET IN TOUCH</h1>
          <h3 className="main__contact__subtitle">
            Ask for a quote or any questions, we will respond to you as soon as
            possible.
          </h3>
        </div>
              ...
              {({
                ...
                <form className="contact__form__div" onSubmit={handleSubmit}>
                  <h2 className="contact__data__span">
                    Provide below your data and explain your idea:
                  </h2>
                  <div className="name__fields__div">
                    <label htmlFor="email" className="field__label__flex__1">
                    ...
                    <label htmlFor="company" className="field__label__flex__1">
